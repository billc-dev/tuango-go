...
//		GroupBy(orderhistory.FieldOrderID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OrderHistory.Query().
//		Select(orderhistory.FieldOrderID).
//		Scan(ctx, &v)
...
func (ohq *OrderHistoryQuery) Modify(modifiers ...func(s *sql.Selector)) *OrderHistorySelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ohs *OrderHistorySelect) Modify(modifiers ...func(s *sql.Selector)) *OrderHistorySelect {
