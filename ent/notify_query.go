...
func (nq *NotifyQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (nq *NotifyQuery) FirstIDX(ctx context.Context) string {
...
func (nq *NotifyQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (nq *NotifyQuery) OnlyIDX(ctx context.Context) string {
...
func (nq *NotifyQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (nq *NotifyQuery) IDsX(ctx context.Context) []string {
	ids, err := nq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (nq *NotifyQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(notify.Table, notify.Columns, sqlgraph.NewFieldSpec(notify.FieldID, field.TypeString))
	_spec.From = nq.sql
...
func (nq *NotifyQuery) Modify(modifiers ...func(s *sql.Selector)) *NotifySelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ns *NotifySelect) Modify(modifiers ...func(s *sql.Selector)) *NotifySelect {
