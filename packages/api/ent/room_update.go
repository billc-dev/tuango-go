...
func (ru *RoomUpdate) SetLastMessage(s string) *RoomUpdate {
	ru.mutation.SetLastMessage(s)
	return ru
}
...
func (ru *RoomUpdate) AddRoomMessageIDs(ids ...string) *RoomUpdate {
	ru.mutation.AddRoomMessageIDs(ids...)
	return ru
}

// AddRoomMessages adds the "room_messages" edges to the Message entity.
func (ru *RoomUpdate) AddRoomMessages(m ...*Message) *RoomUpdate {
	ids := make([]string, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return ru.AddRoomMessageIDs(ids...)
}

// AddRoomUserIDs adds the "room_users" edge to the RoomUser entity by IDs.
func (ru *RoomUpdate) AddRoomUserIDs(ids ...string) *RoomUpdate {
...
// ClearRoomMessages clears all "room_messages" edges to the Message entity.
func (ru *RoomUpdate) ClearRoomMessages() *RoomUpdate {
	ru.mutation.ClearRoomMessages()
	return ru
}

// RemoveRoomMessageIDs removes the "room_messages" edge to Message entities by IDs.
func (ru *RoomUpdate) RemoveRoomMessageIDs(ids ...string) *RoomUpdate {
	ru.mutation.RemoveRoomMessageIDs(ids...)
	return ru
}

// RemoveRoomMessages removes "room_messages" edges to Message entities.
func (ru *RoomUpdate) RemoveRoomMessages(m ...*Message) *RoomUpdate {
	ids := make([]string, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return ru.RemoveRoomMessageIDs(ids...)
}
...
func (ru *RoomUpdate) RemoveRoomUserIDs(ids ...string) *RoomUpdate {
...
func (ru *RoomUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ru.mutation.LastMessage(); ok {
	...
	if ru.mutation.RoomMessagesCleared() {
	...
	if nodes := ru.mutation.RemovedRoomMessagesIDs(); len(nodes) > 0 && !ru.mutation.RoomMessagesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   room.RoomMessagesTable,
	...
	if nodes := ru.mutation.RoomMessagesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   room.RoomMessagesTable,
...
// SetLastMessage sets the "last_message" field.
func (ruo *RoomUpdateOne) SetLastMessage(s string) *RoomUpdateOne {
	ruo.mutation.SetLastMessage(s)
	return ruo
}
...
// AddRoomMessageIDs adds the "room_messages" edge to the Message entity by IDs.
func (ruo *RoomUpdateOne) AddRoomMessageIDs(ids ...string) *RoomUpdateOne {
	ruo.mutation.AddRoomMessageIDs(ids...)
	return ruo
}

// AddRoomMessages adds the "room_messages" edges to the Message entity.
func (ruo *RoomUpdateOne) AddRoomMessages(m ...*Message) *RoomUpdateOne {
	ids := make([]string, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return ruo.AddRoomMessageIDs(ids...)
}

// AddRoomUserIDs adds the "room_users" edge to the RoomUser entity by IDs.
func (ruo *RoomUpdateOne) AddRoomUserIDs(ids ...string) *RoomUpdateOne {
...
// ClearRoomMessages clears all "room_messages" edges to the Message entity.
func (ruo *RoomUpdateOne) ClearRoomMessages() *RoomUpdateOne {
	ruo.mutation.ClearRoomMessages()
	return ruo
}

// RemoveRoomMessageIDs removes the "room_messages" edge to Message entities by IDs.
func (ruo *RoomUpdateOne) RemoveRoomMessageIDs(ids ...string) *RoomUpdateOne {
	ruo.mutation.RemoveRoomMessageIDs(ids...)
	return ruo
}

// RemoveRoomMessages removes "room_messages" edges to Message entities.
func (ruo *RoomUpdateOne) RemoveRoomMessages(m ...*Message) *RoomUpdateOne {
	ids := make([]string, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return ruo.RemoveRoomMessageIDs(ids...)
}
...
// RemoveRoomUserIDs removes the "room_users" edge to RoomUser entities by IDs.
func (ruo *RoomUpdateOne) RemoveRoomUserIDs(ids ...string) *RoomUpdateOne {
...
func (ruo *RoomUpdateOne) sqlSave(ctx context.Context) (_node *Room, err error) {
	...
	if value, ok := ruo.mutation.LastMessage(); ok {
		_spec.SetField(room.FieldLastMessage, field.TypeString, value)
	}
	if value, ok := ruo.mutation.UpdatedAt(); ok {
		_spec.SetField(room.FieldUpdatedAt, field.TypeTime, value)
	}
	if ruo.mutation.RoomMessagesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   room.RoomMessagesTable,
	...
	if nodes := ruo.mutation.RemovedRoomMessagesIDs(); len(nodes) > 0 && !ruo.mutation.RoomMessagesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   room.RoomMessagesTable,
	...
	if nodes := ruo.mutation.RoomMessagesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   room.RoomMessagesTable,
